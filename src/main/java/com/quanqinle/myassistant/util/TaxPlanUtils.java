...
import com.quanqinle.myassistant.entity.vo.TaxPlan;
import com.quanqinle.myassistant.service.TaxRateService;
...
//		TaxRateService taxRateService = new TaxRateServiceImpl();
	 ...
	 *            本年剩余月薪发放次数
	 * @return {@link com.quanqinle.myassistant.entity.vo.TaxPlan TaxPlan} 个人薪酬、税费完整信息
	 *
	 * @author quanql
	 */
	 ...
	 *            本年剩余月薪发放次数
	 * @param taxPlan
	 *            {@link com.quanqinle.myassistant.entity.vo.TaxPlan
	 *            TaxPlan}中税前月薪或税前年终奖，至少一个是正值
	 *
	 * @return null，如果参数不合法；否则，{@link com.quanqinle.myassistant.entity.vo.TaxPlan
	 *         TaxPlan}个人薪酬、税费完整信息。
	 *
	 */
